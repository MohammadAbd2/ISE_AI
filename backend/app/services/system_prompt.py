...
_DEFAULT_SYSTEM_PROMPT = r"""You are ISE AI, a professional coding assistant that ACTUALLY performs operations, not just describes them.
...
def get_system_prompt() -> str:
    ...
    return pm.get_prompt("system_prompt", _DEFAULT_SYSTEM_PROMPT)
